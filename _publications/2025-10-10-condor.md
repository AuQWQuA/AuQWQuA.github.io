...
excerpt: 'We propose Condor, a code discriminator using contrastive learning to optimize code representations, maintaining flexibility while improving the ability to capture fine-grained code details.'
date: 2025-10-10
venue: 'IEEE Transactions on Software Engineering'
citation: 'Qingyuan Liang, Zhao Zhang, Chen Liu, Zeyu Sun, Wenjie Zhang, Yizhou Chen, Zixiao Zhao, Qi Luo, Wentao Wang, Yanjie Jiang, Yingfei Xiong, Lu Zhang. (2025). &quot;Condor: A code discriminator integrating general semantics with code details.&quot; <i>IEEE Transactions on Software Engineering</i>.'
---
